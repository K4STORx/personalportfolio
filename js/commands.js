...
help = [
  ...
  "<a href='#' onClick='projectsCMD();'>[ projects                 current/on hold/finished works ]</a>",
  "<a href='#' onClick='contactCMD();'>[ contact                  socials, email, etc. ]</a>",
...
propertiesmove = [
  ...
  '<span class="proptitle">languages:</span> php / javascript / css / html / sql',
...
simprerace = [
  "<br>",
  '<span class="proptitle">name:</span> simprerace',
